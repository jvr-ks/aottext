...
class Scintilla extends Gui.Custom {
    ...
    Static __New() {                                                        ; Need to do it this way.
        ...
        if !DllCall("LoadLibrary", "Str", "lexer.dll", "UPtr") {
            Msgbox "lexer.dll not found."
            ExitApp
        }
    ...
    Static AddScintilla(_gui, sOptions) {
        ...
        result := DllCall("Lexer\Init","UPtr",ctl.hwnd,"UPtr") ; init DLL and get direct func/ptr
    ...
    ChunkColoring(scn, data, wordList) { ; the DLL -- avg = 0.68 secs
        result := DllCall("Lexer\ChunkColoring","UPtr",data.ptr,"Int",this.loading,"UPtr", wordList.ptr,"Int",this.CaseSense)
    ...
    DeleteRoutine(scn, data) { ; the DLL -- avg = 0.68 secs
        return DllCall("Lexer\DeleteRoutine", "UPtr", data.ptr)
    }
    ...
    DefaultTheme() {
        ...
        this.cust.Editor.Font := guiMainEditFontName
        this.cust.Editor.Size := guiMainEditFontSize
